...
if nav == "Time Series Analysis":
   ...
   if dropdown == 'Raw Data "Yearly"':
      ...
      with tab4:
         ...
         # label the bar
         for rec, label in zip(plot_century.patches,century['CO2'].round(2).astype(str)):
      ...
      with tab5:
         ...
         with col1:
            ...
            # label the bar
            for rec, label in zip(plot_decade_min.patches,decade['CO2'].round(2).astype(str)):
         ...
         with col2:
            ...
            # label the bar
            for rec, label in zip(plot_decade_max.patches,decade['CO2'].round(2).astype(str)):
         ...
         with col3:
            ...
            # label the bar
            for rec, label in zip(plot_decade_avg.patches, decade['CO2'].round(2).astype(str)):
